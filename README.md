...
Внимение! Для работы обогатитетя daoLastFm нужен токен, который я из соображений безопасности не выложил, поэтому по цепочке обогатителей будет срабатывать только trackEnricherDefault.
